...
export default function FontMinPage() {
  ...
  const handleSelectFont = useCallback((fontName: string, selected: boolean) => {
    setSelectedFonts((prev) =>
      selected ? [...prev, fontName] : prev.filter((name) => name !== fontName)
    )
  }, [])
      ...
      <header className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-foreground">FontMin - 字里行间</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6 lg:col-span-1">
            ...
            <Card>
              <CardHeader className="pb-4">
                <CardTitle className="text-lg text-foreground">已上传字体</CardTitle>
              </CardHeader>
              <CardContent>
                {error ? (
          ...
          <div className="lg:col-span-2">
            <Card className="h-full">
              <CardHeader className="pb-4">
                <CardTitle className="text-lg text-foreground">字体预览</CardTitle>
              </CardHeader>
              <CardContent>
                <FontPreview
                  fonts={fonts}
        ...
        <div className="mt-6">
          <Card>
            <CardHeader className="pb-4">
              <CardTitle className="text-lg text-foreground">下载设置</CardTitle>
            </CardHeader>
            <CardContent>
              <DownloadPanel
                selectedFonts={selectedFonts}
